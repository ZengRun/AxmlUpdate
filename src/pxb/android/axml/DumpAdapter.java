...
public class DumpAdapter extends AxmlVisitor {
    ...
    public static class DumpNodeAdapter extends NodeVisitor {
        ...
        //2014,12,10
//        public NodeVisitor addChild(String namespace,String parentNode,String childName){
//        	NodeVisitor nv=super.addChild(namespace, parentNode,childName);
//        	return new DumpNodeAdapter(writer, nv, depth + 1, nses, namespace, childName);
//        }
